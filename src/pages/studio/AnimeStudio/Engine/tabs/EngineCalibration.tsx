      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-b border-white/5 pb-10">
        <div className="space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/20 rounded-full">
            ...
            <span className="text-[8px] font-black text-amber-500 uppercase tracking-[0.2em]">Parameter Calibration</span>
          </div>
          ...
          <p className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest italic">Fine-tuning the generative logic of {selectedModel}</p>
        </div>
        ...
        <div className="flex items-center gap-4">
           <button 
             ...
             className="px-6 h-12 rounded-xl bg-white/5 border border-white/10 text-white text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-3"
           >
          ...
          {parameters.map((param) => (
            <div key={param.id} className="space-y-6 group">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-5">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-[11px] font-black text-white uppercase tracking-widest leading-none">{param.label}</h4>
                    <p className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest mt-0.5 leading-none">{param.desc}</p>
                  </div>
                </div>
              ...
              <div className="relative pt-2">
                ...
                />
                <div className="flex justify-between mt-3 text-[8px] font-black text-zinc-700 uppercase tracking-widest px-1">
                  <span>{param.min}</span>
                  <span>{param.max}</span>
                </div>
              </div>
          ...
          <div className="p-10 bg-[#050505] border border-white/5 rounded-[2.5rem] relative overflow-hidden group shadow-2xl">
            ...
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                 ...
                 <span className="text-[8px] font-black text-zinc-600 uppercase tracking-widest mt-1.5 block italic">Real-time Diagnostic</span>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-2">
                 <span className="text-[8px] font-black text-zinc-500 uppercase tracking-widest block">Content Specialization</span>
                 <div className="px-5 py-4 bg-white/[0.02] border border-white/5 rounded-2xl">
                    <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">{contentType} Optimized</span>
                 </div>
              </div>
