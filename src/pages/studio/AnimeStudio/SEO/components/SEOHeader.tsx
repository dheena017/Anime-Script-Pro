...
import { ChevronLeft, ChevronRight, Cpu, Search, RefreshCw, Sparkles, Save } from 'lucide-react';
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-between p-4 md:p-5 bg-[#050505]/95 backdrop-blur-md border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden gap-6 lg:gap-0">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-8 z-10 w-full lg:w-auto">
            <div className="relative shrink-0">
              <div className="w-14 h-14 rounded-2xl bg-yellow-500/10 border border-yellow-500/30 flex items-center justify-center shadow-[0_0_20px_rgba(234,179,8,0.2)] group/icon overflow-hidden">
            ...
            {onPrev && (
              <Tooltip>
                <TooltipTrigger>
                  <Button
                    variant="outline"
                    className="relative w-full sm:w-auto h-12 px-8 bg-[#050505] border-white/10 text-zinc-400 hover:text-yellow-500 hover:border-yellow-500/50 font-black uppercase tracking-widest text-[10px] rounded-full transition-all duration-500 backdrop-blur-md group/back shadow-2xl"
                    onClick={onPrev}
                  >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <Tooltip>
                <TooltipTrigger>
                  <Button
                    variant="outline"
                    className="relative w-full sm:w-auto h-12 px-8 bg-[#050505] border-white/10 text-zinc-100 hover:text-yellow-500 hover:border-yellow-500/50 font-black uppercase tracking-widest text-[11px] rounded-full transition-all duration-500 backdrop-blur-md group/btn shadow-2xl"
                  ...
                  >
                    ...
                    {isGenerating ? (
                      <RefreshCw className="w-4 h-4 animate-spin mr-3 text-yellow-500" />
                    ) : (
              ...
              <Tooltip>
                <TooltipTrigger>
                  <Button
                    className="relative w-full sm:w-auto h-12 px-10 rounded-full bg-[#050505] border border-white/10 text-zinc-400 hover:text-yellow-500 hover:border-yellow-500/50 font-black uppercase tracking-widest text-[10px] transition-all duration-500 backdrop-blur-md group/next shadow-2xl"
                    onClick={onNext}
                  >
