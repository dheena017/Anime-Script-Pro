...
export default function AnimePortal() {
  ...
  const stats = [
    { label: 'Active Productions', value: '12', icon: Film, color: 'text-orange-500' },
    { label: 'Episodes Drafted', value: animeHistory.length.toString(), icon: Zap, color: 'text-yellow-500' },
    { label: 'Top Genre', value: 'Shonen', icon: Target, color: 'text-red-500' },
  ];
  ...
  const tools = [
    { 
      id: 'script', 
      label: 'Script Engine', 
      desc: 'High-speed dialogue and action sequence generation.', 
      icon: ScrollText, 
      path: 'script',
      bg: 'bg-orange-500/10',
    ...
    { 
      id: 'world', 
      label: 'Lore Vault', 
      desc: 'Central repository for power systems, history, and geography.', 
      icon: Sparkles, 
      path: 'world',
      bg: 'bg-yellow-500/10',
    ...
    { 
      id: 'cast', 
      label: 'Cast Studio', 
      desc: 'Hero and villain visual and psychological profiling.', 
      icon: Users, 
      path: 'cast',
      bg: 'bg-orange-500/10',
      border: 'border-orange-500/20'
    ...
    { 
      id: 'storyboard', 
      label: 'Vision Board', 
      desc: 'Cinematic storyboard planning with scene-by-scene logic.', 
      icon: LayoutGrid, 
      path: 'storyboard',
      bg: 'bg-yellow-500/10',
      border: 'border-yellow-500/20'
      ...
      <div className="space-y-6 pt-4">
        <div className="flex items-center justify-between">
           <h2 className="text-sm font-black text-white uppercase tracking-[0.3em] flex items-center gap-3">
              ...
              Anime Production Suite
           </h2>
           <p className="text-[10px] text-zinc-500 font-black uppercase tracking-widest">Active Toolset</p>
        </div>
