  ...
  return (
    <div className="py-20 text-center space-y-6 bg-zinc-950/40 rounded-[4rem] border border-dashed border-white/5">
      ...
      <div className="space-y-2">
        ...
        <p className="text-[10px] font-black text-zinc-700 uppercase tracking-[0.4em]">Deep storage archives are currently being synchronized.</p>
      </div>
      ...
      <div className="max-w-md mx-auto p-6 bg-zinc-900/50 rounded-3xl border border-white/5 space-y-4">
        <div className="flex items-center gap-3 text-left">
          ...
          <div>
            ...
            <p className="text-[8px] font-bold text-zinc-500 uppercase">Archive retrieval protocols are undergoing maintenance.</p>
          </div>
        </div>
      </div>
    </div>
