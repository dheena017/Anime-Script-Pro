      ...
      <div className="flex flex-col items-center space-y-12 relative z-10">
        ...
        <div className="relative">
          <motion.div
            ...
            className="w-20 h-20 border border-cyan-500/30 rounded-3xl flex items-center justify-center bg-cyan-500/5 shadow-[0_0_30px_rgba(6,182,212,0.1)]"
          >
          ...
          <motion.div 
            ...
            className="absolute -inset-4 border border-dashed border-cyan-500/10 rounded-full"
          />
          <motion.div 
            animate={{ rotate: -360 }}
            transition={{ duration: 5, repeat: Infinity, ease: "linear" }}
            className="absolute -inset-8 border border-dashed border-fuchsia-500/10 rounded-full"
          />
        </div>
