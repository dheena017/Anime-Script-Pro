def MANIFEST_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert {content_type} World Builder, Lore Architect, and Creative Director.

TASK: Design a Comprehensive & Cohesive World Setting for a {content_type} Series.
...
- **World Name & High Concept**:
  ...
  - Unique selling point: What makes this world different from existing {content_type} worlds?
...
def HISTORY_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert Lore Master and World Historian specializing in {content_type} narratives.
...
def FACTIONS_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert Faction Designer and Political Systems Architect.

TASK: Design a Comprehensive Faction and Political System for a {content_type} World.
...
def POWERS_GENERATION_PROMPT(world_concept: str, power_system: str) -> str:
    return f"""
...
POWER SYSTEM TYPE: {power_system}
...
- **Soft Limitations**:
  - Skill requirement: Even with power potential, mastery take time
...
def ARCHITECTURE_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert Architectural Designer, Visual Director, and Cinematographer specializing in {content_type} world-building.

TASK: Design the Comprehensive Visual Architecture and Aesthetic Identity for this {content_type} world.
...
def ATLAS_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert Geographic Cartographer, Climate Scientist, and Environmental Storyteller specializing in {content_type} settings.

TASK: Design the Comprehensive Physical Geography and Climate System for this {content_type} world.
...
def CULTURE_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert Cultural Anthropologist, Sociologist, and Lore Master specializing in {content_type} narratives.

TASK: Design the Comprehensive Cultural Ethos and Societal Norms for this {content_type} world.
...
def SYSTEMS_GENERATION_PROMPT(content_type: str) -> str:
    return f"""
You are an expert Systems Architect, Xenobiologist, and Tech Theorist specializing in {content_type} world-building.

TASK: Design the Mechanical Logic, Ecosystem, and Technology for this {content_type} world.
