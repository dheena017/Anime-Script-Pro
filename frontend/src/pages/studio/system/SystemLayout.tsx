...
export const SystemLayout: React.FC<SystemLayoutProps> = ({
  ...
  React.useEffect(() => {
    studioLog('SystemLayout', 'System Protocol Interface synchronized.', 'system');
  }, []);

  React.useEffect(() => {
    reportTabChange('SystemLayout', activeTab, 'system');
  }, [activeTab]);
  ...
  return (
    <div className={s.moduleContainer}>
      ...
      {/* SECTION 3: TABS */}
      <StudioTabRail tabs={tabs} activeTab={activeTab} onTabChange={onTabChange} layoutId="sysTab" />
