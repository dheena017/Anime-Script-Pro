      ...
      <div className="flex items-center gap-4 flex-1 min-w-[300px]">
        <div className="relative flex-1 group">
          ...
          <input 
            ...
            className="w-full bg-zinc-900/50 border border-white/5 rounded-2xl py-4 pl-14 pr-6 text-xs font-bold text-white placeholder:text-zinc-700 focus:outline-none focus:border-[#bd4a4a]/50 focus:ring-4 focus:ring-[#bd4a4a]/5 transition-all"
          />
        </div>
        ...
        <Button variant="outline" className="h-[52px] bg-zinc-900/50 border-white/5 rounded-2xl px-6 hover:bg-zinc-800 transition-all group">
          ...
          <span className="text-xs font-black uppercase tracking-widest text-zinc-400 group-hover:text-white">Curriculum Filter</span>
        </Button>
      </div>

      <div className="flex items-center gap-6">
        <div className="flex items-center gap-2">
          <span className="text-xs font-black uppercase tracking-widest text-zinc-600">Difficulty:</span>
          <button className="flex items-center gap-2 px-4 py-2 bg-zinc-900 rounded-xl text-xs font-black text-white uppercase tracking-widest border border-white/5 hover:border-white/10 transition-all">
        ...
        <Button variant="ghost" className="h-[52px] rounded-2xl px-6 hover:bg-zinc-900 text-zinc-400 hover:text-white transition-all group">
          ...
          <span className="text-xs font-black uppercase tracking-widest">Saved Guides</span>
        </Button>
      </div>
    </div>
  );
