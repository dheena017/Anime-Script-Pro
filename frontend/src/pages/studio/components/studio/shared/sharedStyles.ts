export const sharedStyles = {
  ...
  headerTitle: "text-2xl md:text-3xl font-black italic uppercase tracking-tighter text-white leading-none",
  headerSubtitle: "text-xs font-bold text-zinc-500 uppercase tracking-[0.4em] mt-4",
  headerBadges: "flex items-center gap-3",
  headerBadge: "px-3 py-1 rounded-full text-xs font-black uppercase tracking-widest border transition-all",
  ...
  tabItem: "relative px-6 py-3.5 rounded-[1.2rem] text-xs font-black uppercase tracking-[0.15em] flex items-center gap-3 transition-all whitespace-nowrap overflow-hidden",
