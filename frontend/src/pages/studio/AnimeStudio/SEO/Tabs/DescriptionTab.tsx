            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-1000">
              <ReactMarkdown
                components={{
                  ...
                  h2: ({node, ...props}) => <h2 className="text-lg font-black text-fuchsia-400 uppercase tracking-widest mb-4 mt-8" {...props} />,
                  ...
                  strong: ({node, ...props}) => <strong className="text-fuchsia-300 font-black" {...props} />,
                  em: ({node, ...props}) => <em className="italic text-zinc-300" {...props} />,
                  blockquote: ({node, ...props}) => <blockquote className="border-l-2 border-fuchsia-500 pl-4 italic text-zinc-400 bg-fuchsia-500/5 p-3 rounded-r-lg my-4" {...props} />,
                  code: ({node, inline, className, children, ...props}: any) => {
                    return inline ? (
                      <code className="px-2 py-0.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-fuchsia-300" {...props}>{children}</code>
                    ) : (
