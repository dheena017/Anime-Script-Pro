...
> = {
  keywords: {
    title: "Indexing Keywords",
    description: "Generating search-engine friendly titles and indexing tags",
    icon: FileSearch,
  ...
  description: {
    ...
    description: "Drafting compelling series and episode summaries",
    icon: Megaphone,
  ...
  alt: {
    title: "Generating Alt Texts",
    description: "Creating accessibility-compliant image descriptions",
    icon: Search,
    color: "text-teal-400",
  ...
  tags: {
    title: "Building Meta Tags",
    description: "Structuring metadata for platform indexing",
    icon: FileSearch,
    color: "text-cyan-400",
  ...
  distribution: {
    ...
    description: "Mapping content strategy and platform reach",
    icon: Share2,
    color: "text-blue-400",
  ...
  growth: {
    ...
    description: "Projecting audience retention and growth trends",
    icon: TrendingUp,
    color: "text-lime-400",
...
export function SEOLoadingPage({
  tab,
  title,
  description,
  progress,
  ...
  const isActive =
    gen.isGeneratingMetadata ||
    gen.isGeneratingDistribution ||
    gen.isGeneratingGrowthStrategy ||
    gen.isLoading;
  ...
  const meta =
    tab && TAB_META[tab]
      ...
      : {
          ...
          description:
            description || "Improving discoverability and platform reach",
          icon: Search,
          color: "text-green-400",
          accentColor: "text-green-400",
          borderColor: "border-green-500/20",
