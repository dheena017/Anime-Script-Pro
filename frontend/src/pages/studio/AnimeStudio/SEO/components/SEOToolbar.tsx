  ...
  const getTabLabel = () => {
    switch (activeTab) {
      case "keywords":
        return {
          title: "Keyword Atlas",
          desc: "Title suggestions and primary search discovery keywords",
        };
      case "description":
        return {
          title: "Conversion Description",
          desc: "High-conversion episodic narrative overview",
        };
      case "alt":
        return {
          title: "Visual Alt-Captions",
          desc: "Accessibility-ready image metadata specifications",
        };
      case "tags":
        return {
          title: "Tag Cluster Manifest",
          desc: "Optimized tags list for search indexing and discovery",
        };
      case "distribution":
        return {
          title: "Multi-Channel Blueprint",
          desc: "Episodic publishing guidelines and amplification plan",
        };
      case "growth":
        return {
          title: "Strategic Growth Blueprints",
          desc: "Audience retention checkpoints and tactical recommendations",
        };
      default:
        return {
          title: "SEO Nexus Control",
          desc: "Unified metadata & search discovery optimizer",
        };
    }
  };
  ...
  const getTabMetrics = () => {
    ...
    switch (activeTab) {
      ...
      case "description": {
        ...
        return {
          label: "scale",
          value: `${len} / 5000 chars`,
          status: len <= 5000 ? "optimal" : "warning",
        };
      }
      case "alt": {
        const len = content.length;
        return {
          label: "scale",
          value: `${len} / 250 chars`,
          status: len <= 250 ? "optimal" : "warning",
        };
      }
      case "tags": {
        const count = content
        ...
        return {
          label: "count",
          value: `${count} Tags`,
          status: count <= 25 ? "optimal" : "warning",
        };
      }
      case "distribution": {
        ...
        <div className={s.toolbar.header}>
          ...
          <div className={s.toolbar.statusBox}>
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className={s.toolbar.statusSubtitle}>{tabLabel.desc}</span>
            </div>
          </div>
