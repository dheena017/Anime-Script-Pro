...
export const seriesStyles = {
  ...
  header: {
    ...
    actionButtonPrimary: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-emerald-500/30 bg-emerald-500/5 text-emerald-400 hover:bg-emerald-500/10 hover:border-emerald-500/60 hover:text-emerald-300 font-black uppercase tracking-widest text-[9px] transition-all duration-300 group/btn shadow-lg",
    ...
    nextButton: "relative w-full sm:w-auto h-10 px-8 rounded-full border border-emerald-500/30 bg-emerald-500/5 text-emerald-400 hover:bg-emerald-500/10 hover:border-emerald-500/60 hover:text-emerald-300 font-black uppercase tracking-widest text-[9px] transition-all duration-300 group/next shadow-lg",
  },
