...
export function SeriesEmptyTab({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[800px] py-12 px-8 relative overflow-hidden">
      ...
      {/* Main Center Stage */}
      <div className="w-full max-w-5xl bg-[#050505]/40 backdrop-blur-2xl border border-white/5 rounded-[4rem] p-12 md:p-20 relative z-10 shadow-2xl overflow-hidden group mb-12">
