...
export const assetsStyles = {
  ...
  header: {
    ...
    btnPrev: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-emerald-500/50 hover:text-emerald-400 font-black uppercase tracking-widest text-xs transition-all duration-300 group/back shadow-lg",
    btnRegen: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-emerald-500/50 hover:text-emerald-400 font-black uppercase tracking-widest text-xs transition-all duration-300 group/regen shadow-lg",
    btnNext: "relative w-full sm:w-auto h-10 px-8 rounded-full border border-emerald-500/30 bg-emerald-500/5 text-emerald-400 hover:bg-emerald-500/10 hover:border-emerald-500/60 hover:text-emerald-300 font-black uppercase tracking-widest text-xs transition-all duration-300 group/btn shadow-lg",
  },
  ...
  page: {
    ...
    heroBadge: "inline-flex items-center gap-2 px-3 py-1 rounded-full bg-studio/10 border border-studio/20 text-xs font-black text-studio uppercase tracking-widest mb-4",
    heroTitle: "text-4xl lg:text-2xl font-black text-white uppercase tracking-tighter italic leading-none",
    heroLogline: "text-zinc-500 text-sm font-medium max-w-xl leading-relaxed mt-4",
    statGrid: "grid grid-cols-3 gap-4 shrink-0",
    statCard: "bg-black/40 border border-white/5 rounded-2xl p-4 text-center text-xs font-black uppercase tracking-widest text-zinc-500 hover:border-studio/30 transition-all duration-500",
  ...
  card: {
    ...
    subtitle: "text-xs font-bold text-zinc-500 uppercase tracking-widest mt-1",
    actionIconButton: "h-10 w-10 rounded-xl border transition-all duration-300",
    actionButton: "h-10 border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-studio/50 hover:text-studio font-black uppercase tracking-widest text-xs transition-all duration-300",
    actionButtonPrimary: "h-10 rounded-xl bg-white text-black hover:bg-zinc-100 font-black uppercase tracking-widest text-xs px-6 transition-all duration-300",
  ...
  tabs: {
    ...
    nexusLabel: "text-xs font-black text-studio uppercase tracking-[0.2em]",
  }
};
