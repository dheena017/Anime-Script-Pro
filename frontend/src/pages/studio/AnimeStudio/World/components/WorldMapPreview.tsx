    ...
    <div className="map-preview-container">
      <div className="map-preview-header">
        ...
        <div className="flex gap-1">
          <Button
            variant="ghost"
            size="icon"
            className={cn(s.actionIconButtonSmall, "hover:text-emerald-500")}
          >
      ...
      <Card className="map-preview-card">
        ...
        <div className="map-preview-point">
          ...
          <div className="map-preview-label">The Citadel</div>
        </div>

        <div className="map-preview-coords">Grid: 42.1N 88.4W</div>
      </Card>
    </div>
  );
};
