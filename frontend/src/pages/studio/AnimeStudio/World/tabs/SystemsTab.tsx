    ...
    return [
      {
        title: "Power System",
        desc: findVal(
          /(?:Power System|Power):\s*(.*)/i,
          "Energy manipulation through cognitive overloading.",
        ),
        icon: Zap,
      ...
      },
      {
        title: "Economy",
        desc: findVal(
          /(?:Economy|Currency):\s*(.*)/i,
          "Credits & Karma: A dual-currency social contribution system.",
        ),
        icon: Activity,
        color: "text-blue-400",
      },
      {
        title: "Governance",
        desc: findVal(
          /(?:Governance|Government):\s*(.*)/i,
          "Algorithm Sovereignty by planetary AI core.",
        ),
        icon: ShieldCheck,
      ...
      },
      {
        title: "Social Strata",
        desc: findVal(
          /(?:Social Hierarchy|Social Strata):\s*(.*)/i,
          "The Indexed vs The Ghost: System net accessibility.",
        ),
        icon: Cpu,
        color: "text-cyan-400",
      },
        ...
        <div className={s.content.contentArea}>
          <div className={s.content.mainColumn}>
            <div
              ...
              style={
                { "--prose-accent-color": "#10b981" } as React.CSSProperties
              }
            >
            ...
            <div className={s.content.sidebarCard}>
              ...
              <div className={s.content.sidebarContent}>
                <div className="flex items-center justify-between">
                  ...
                  {isEditing && (
                    <span className="text-xs font-bold text-emerald-500/50 uppercase">
                      Modular Prompt
                    </span>
                  )}
                </div>
                ...
                <p className={s.content.sidebarNote}>
                  Focus the AI on specific economic models, governance
                  structures, or technological laws unique to this world.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {systems.map((sys, i) => (
                <motion.div
                  ...
                  className={
                    s.content.statCard + " hover:border-emerald-500/30"
                  }
                >
