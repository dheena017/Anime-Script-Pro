        ...
        <div className={s.content.contentArea}>
          <div className={s.content.mainColumn}>
            <div
              ...
              style={
                { "--prose-accent-color": "#22d3ee" } as React.CSSProperties
              }
            >
            ...
            <div className={s.content.sidebarCard}>
              ...
              <div className={s.content.sidebarContent}>
                ...
                <p className={s.content.sidebarNote}>
                  Focus the AI on specific terrain types, climate anomalies, or
                  strategic landmarks.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 gap-3">
                {locations.length > 0 ? (
                  locations.map((loc, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 p-3 bg-white/[0.02] border border-white/5 rounded-xl group hover:border-blue-500/30 transition-all"
                    >
                      <MapPin className="w-3 h-3 text-blue-500/50 group-hover:text-blue-400" />
                      <span className="text-xs font-bold text-zinc-500 group-hover:text-zinc-300 uppercase tracking-tight">
                        {loc}
                      </span>
                    </div>
                  ))
