...
import { Users, Music, Utensils, Heart, Sparkles, ClipboardList, Download, ScrollText } from 'lucide-react';
            ...
            <div className={s.content.sidebarCard}>
              ...
              <div className={s.content.sidebarContent}>
                <div className="flex items-center justify-between">
                  ...
                  {isEditing && <span className="text-xs font-bold text-rose-500/50 uppercase">Modular Prompt</span>}
                </div>
