...
export const ArchitectureTab: React.FC<ArchitectureTabProps> = ({
  ...
  const structures = React.useMemo(() => {
    ...
    return [
      {
        label: "Style",
        val: findVal(/(?:Style|Aesthetic):\s*(.*)/i, "Brutalist Neofuturism"),
        icon: Landmark,
      ...
      {
        label: "Scale",
        val: findVal(/(?:Scale|Density):\s*(.*)/i, "Vertical Megacities"),
        icon: Building2,
        color: "text-blue-400",
      },
      {
        label: "Common",
        val: findVal(/(?:Housing|Living):\s*(.*)/i, "Modular Capsule Pods"),
        icon: Home,
        ...
        <div className={s.content.contentArea}>
          <div className={s.content.mainColumn}>
            <div
              ...
              style={
                { "--prose-accent-color": "#f97316" } as React.CSSProperties
              }
            >
            ...
            <div className={s.content.sidebarCard}>
              ...
              <div className={s.content.sidebarContent}>
                <div className="flex items-center justify-between">
                  ...
                  {isEditing && (
                    <span className="text-xs font-bold text-orange-500/50 uppercase">
                      Modular Prompt
                    </span>
                  )}
                </div>
                ...
                <p className={s.content.sidebarNote}>
                  Focus the AI on specific aesthetics, building materials, or
            ...
            <div className="grid grid-cols-1 gap-4">
              {structures.map((item, i) => (
                <motion.div
                  ...
                  className={
                    s.content.statCard +
                    " flex items-center gap-5 border-r-2 border-r-orange-500/20"
                  }
                >
