...
export const ManifestTab: React.FC<ManifestTabProps> = ({
  ...
  return (
    <div
      className={s.content.container + " will-change-transform transform-gpu"}
    >
      {isEditing ? (
        <StudioEditor
          content={content}
            ...
            <div className={s.content.sidebarCard}>
              <div
                className={
                  ...
                  " bg-studio/5 group-hover:bg-studio/10"
                }
              />
              <div className={s.content.sidebarContent}>
                ...
                <p className={s.content.sidebarNote}>
                  The foundational logline driving the AI's world-building
                  logic.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-black uppercase tracking-tighter ${item.color}`}
                    >
                      {item.val}
                    </span>
                  </div>
