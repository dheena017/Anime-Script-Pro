            ...
            {onPrev && (
              <Tooltip>
                <TooltipTrigger >
                  <Button
                    variant="ghost"
                    className="relative w-full sm:w-auto h-10 px-6 bg-gradient-to-r from-emerald-500/10 to-emerald-500/5 border border-emerald-500/30 text-zinc-400 hover:text-emerald-500 hover:border-emerald-500/60 hover:bg-gradient-to-r hover:from-emerald-500/20 hover:to-emerald-500/10 font-black uppercase tracking-widest text-[9px] rounded-lg transition-all duration-300 group/back shadow-lg hover:shadow-[0_0_20px_rgba(16,185,129,0.3)]"
                    onClick={onPrev}
                  >
              ...
              {onSave && hasContent && (
                <Tooltip>
                  <TooltipTrigger >
                    <Button
                      variant="ghost"
                      className="relative w-full sm:w-auto h-10 px-6 bg-gradient-to-r from-emerald-500/10 to-transparent border border-emerald-500/30 text-emerald-500 hover:text-emerald-400 hover:border-emerald-500/60 hover:bg-gradient-to-r hover:from-emerald-500/20 hover:to-emerald-500/10 font-black uppercase tracking-widest text-[9px] rounded-lg transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(16,185,129,0.2)] group/save"
                      onClick={onSave}
                      disabled={isSaving}
                    >
