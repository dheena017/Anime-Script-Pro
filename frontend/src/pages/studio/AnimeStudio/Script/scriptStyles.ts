...
export const scriptStyles = {
  ...
  header: {
    ...
    actionButton: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-blue-500/50 hover:text-blue-400 font-black uppercase tracking-widest text-xs transition-all duration-300 group/back shadow-lg",
    ...
    actionButtonPrimary: "relative w-full sm:w-auto h-10 px-8 rounded-full border border-blue-500/30 bg-blue-500/5 text-blue-400 hover:bg-blue-500/10 hover:border-blue-500/60 hover:text-blue-300 font-black uppercase tracking-widest text-xs transition-all duration-300 group/btn shadow-lg",
  },
  ...
  toolbar: {
    ...
    statusTitle: "text-xs font-black uppercase tracking-[0.2em] bg-gradient-to-r from-blue-300 to-blue-500 bg-clip-text text-transparent",
    ...
    navButton: "h-8 px-3 rounded-lg text-zinc-400 hover:text-studio border border-transparent hover:border-studio/40 hover:bg-studio/10 transition-all text-xs font-black uppercase tracking-widest gap-2 group relative overflow-hidden",
    navButtonActive: "h-8 px-3 rounded-lg text-studio/80 hover:text-studio transition-all text-xs font-black uppercase tracking-widest gap-2 bg-studio/10 border border-studio/30 hover:border-studio/50 group",
