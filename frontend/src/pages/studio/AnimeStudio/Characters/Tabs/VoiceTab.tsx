                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-6 bg-zinc-950/50 rounded-3xl border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/50 transition-all duration-500">
                      <p className="text-sm font-medium text-zinc-300 leading-relaxed italic">
                        "
                        {toText(
                          char.speakingStyle?.voiceArchetype ||
                            char.voiceArchetype ||
                            "Neutral Tone / Balanced Pitch",
                        )}
                        "
                      </p>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-6 bg-zinc-950/50 rounded-3xl border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/50 transition-all duration-500">
                      <p className="text-xs font-medium text-zinc-400 leading-relaxed uppercase tracking-wide">
                        {toText(
                          char.speakingStyle?.sentence_structure ||
                            char.speakingStyle ||
                      ...
                      <div className="mt-4 pt-4 border-t border-white/5 flex items-center gap-4">
                        <div className="px-3 py-1 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-xs font-black text-cyan-400 uppercase tracking-widest">
                          Rhythm:{" "}
                          {toText(
                            char.speakingStyle?.dialogueRhythm || "Melodic",
                          )}
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="p-6 bg-cyan-500/5 border border-cyan-500/10 rounded-3xl space-y-3">
                      {Array.isArray(char.speakingStyle?.catchphrases) ? (
                        char.speakingStyle?.catchphrases.map(
                          (phrase: string, pIdx: number) => (
                        ...
                        <p className="text-xs text-zinc-500 italic">
                          No signature catchphrases defined.
                        </p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-6 bg-zinc-950/50 rounded-3xl border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/50 transition-all duration-500">
                      <p className="text-sm font-medium text-zinc-300 leading-relaxed">
                        {toText(
                          char.speakingStyle?.emotionalSpectrum ||
                            char.emotionalSpectrum ||
