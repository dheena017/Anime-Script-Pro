      ...
      <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-6 text-center px-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-zinc-500 text-sm max-w-xs">
            The requested emotional thread could not be located in the current
            manifest.
          </p>
        </div>
        <Button
  ...
  return (
    <div className="space-y-12 pb-20 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          onClick={() =>
            navigate(`${basePath}/cast/relationships/${relationshipId}/edit`)
          }
          ...
          <div className="flex flex-col md:flex-row items-center gap-16 w-full justify-center">
            ...
            <div className="flex flex-col items-center gap-4 py-8">
                ...
                <div className="h-[2px] w-24 bg-gradient-to-r from-transparent via-fuchsia-500/50 to-transparent relative">
                  {isHighTension && (
                    <motion.div
                      ...
                      className="absolute -top-1 w-2 h-2 rounded-full bg-red-500 blur-[2px]"
                    />
                  )}
                </div>
              </div>
              <div className="flex items-center gap-2 px-4 py-1.5 bg-black/40 border border-white/5 rounded-full">
                <Activity
                  className={`w-3 h-3 ${isHighTension ? "text-red-500" : "text-fuchsia-500"}`}
                />
                <span className="text-xs font-black text-zinc-500 uppercase tracking-widest">
                  Tension Index: {connection.tension}/10
                </span>
              </div>
            </div>
            ...
            <div className="p-10 bg-black/40 border border-white/5 rounded-[3rem] relative overflow-hidden">
              <p className="text-2xl text-white font-medium italic leading-relaxed relative z-10">
                ...
                {connection.description ||
                  "The nature of this emotional thread remains a strategic mystery within the current lore synthesis."}
                "
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-8 bg-zinc-900/40 border-white/5 space-y-4">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed font-medium italic">
                {connection.tension > 7
                  ? "[HIGH_TENSION_PATHWAY]: Significant conflict probability detected in current scene manifests."
                  : "[STABLE_CONNECTION]: Standard social resonance maintained."}
              </p>
            </Card>
            <Card className="p-8 bg-zinc-900/40 border-white/5 space-y-4">
              <p className="text-xs font-black text-zinc-600 uppercase tracking-widest">
              ...
              <div className="flex items-center justify-between">
                <span className="text-2xl font-black text-white">
                  {connection.tension * 10}%
                </span>
                <div
                  className={`w-12 h-1.5 rounded-full ${isHighTension ? "bg-red-500 shadow-[0_0_10px_rgba(239,68,68,0.5)]" : "bg-fuchsia-500"}`}
                />
              </div>
              <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest">
                Real-time Synthesis Calculation
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="p-8 bg-fuchsia-500/5 border border-fuchsia-500/10 rounded-[2.5rem] space-y-6">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed font-medium italic">
              "Connections with high tension indices are prime candidates for
              Mid-Season Climax manifestation."
            </p>
