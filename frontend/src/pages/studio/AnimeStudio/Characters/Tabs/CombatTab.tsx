    ...
    <div className="space-y-12 pb-20 animate-in fade-in duration-1000">
      <div className="grid grid-cols-1 gap-10">
        {characterList?.map((char: any, idx: number) => {
          const powerLevelNum =
            parseInt(
              toText(char.powerSystem?.powerLevel).replace(/[^0-9]/g, ""),
            ) || 75;
          return (
            <motion.div
              key={idx}
              ...
              <div className="relative z-10 p-10 flex flex-col lg:flex-row gap-12">
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <div className="space-y-3">
                      ...
                      <div className="p-6 bg-zinc-950/50 rounded-3xl border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/50 transition-all duration-500">
                        <h4 className="text-studio font-black uppercase text-xs mb-2 tracking-widest">
                          Deployment Ready
                        </h4>
                        <p className="text-sm font-medium text-zinc-300 leading-relaxed italic">
                          "
                          {toText(
                            char.powerSystem?.signatureAbility ||
                              char.signatureMove ||
                              "Basic Tactical Engagement",
                          )}
                          "
                        </p>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-6 bg-zinc-950/50 rounded-3xl border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/50 transition-all duration-500">
                        <p className="text-xs font-medium text-zinc-400 leading-relaxed uppercase tracking-wide">
                          {toText(
                            char.powerSystem?.defensiveStyle ||
                              char.defensiveStyle ||
                              "Evasive / Parry-Focused",
                          )}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-3">
                      <div className="flex items-center gap-3 text-xs font-black uppercase text-red-500 tracking-[0.2em]">
                        <Video className="w-3.5 h-3.5" /> Director's Camera
                        Notes
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-6 bg-zinc-950/50 rounded-3xl border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/50 transition-all duration-500">
                        <p className="text-sm font-medium text-zinc-300 leading-relaxed">
                          {toText(
                            char.powerSystem?.limitations ||
                              "No critical mechanical failures detected.",
                          )}
                        </p>
                      </div>
                    </div>
