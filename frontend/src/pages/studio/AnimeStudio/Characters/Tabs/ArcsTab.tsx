...
export const ArcsTab: React.FC = () => {
  const { handleLoadDemo } = React.useContext(CharacterPageContext);
  const { characterList, isGeneratingCharacters } = useGeneratorState();
            ...
            <div className="relative z-10 p-12 flex flex-col lg:flex-row gap-12">
              ...
              <div className="shrink-0 flex flex-col items-center lg:items-start gap-6 border-b lg:border-b-0 lg:border-r border-white/5 pb-8 lg:pb-0 lg:pr-12">
                ...
                <div className="text-center lg:text-left space-y-1">
                  ...
                  <p className="text-xs font-black text-fuchsia-500 uppercase tracking-[0.2em]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                  ...
                  <div className="space-y-6 relative">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-zinc-900 border border-fuchsia-500/40 flex items-center justify-center text-xs font-black text-fuchsia-400 shadow-lg">
                        1
                      </div>
                    ...
                    <div className="p-8 bg-zinc-950/40 rounded-[2.5rem] border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/40 transition-all duration-500 min-h-[160px]">
                      <p className="text-sm font-medium text-zinc-400 leading-relaxed italic">
                        "
                        {toText(
                          char.narrative?.arcRoadmap?.initialState ||
                            char.goal ||
                            "Foundational character parameters.",
                        )}
                        "
                      </p>
                    </div>
                  ...
                  <div className="space-y-6 relative">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-fuchsia-500/10 border border-fuchsia-500/40 flex items-center justify-center text-xs font-black text-fuchsia-400 shadow-lg">
                        2
                      </div>
                      <span className="text-xs font-black text-fuchsia-500 uppercase tracking-widest">
                        The Catalyst
                      </span>
                    </div>
                    <div className="p-8 bg-fuchsia-500/5 rounded-[2.5rem] border border-fuchsia-500/10 backdrop-blur-xl group-hover:bg-fuchsia-500/10 transition-all duration-500 min-h-[160px] relative overflow-hidden">
                      ...
                      <p className="text-sm font-medium text-zinc-300 leading-relaxed font-bold">
                        {toText(
                          char.narrative?.arcRoadmap?.catalyst ||
                            char.conflict ||
                            "Primary ideological stressors.",
                        )}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 relative">
                    ...
                    <div className="p-8 bg-zinc-950/40 rounded-[2.5rem] border border-white/5 backdrop-blur-xl group-hover:bg-zinc-900/40 transition-all duration-500 min-h-[160px]">
                      <p className="text-sm font-medium text-zinc-400 leading-relaxed">
                        {toText(
                          char.narrative?.arcRoadmap?.finalTransformation ||
                            char.secret ||
                ...
                <div className="mt-12 p-8 bg-gradient-to-br from-fuchsia-500/10 to-transparent rounded-[3rem] border border-fuchsia-500/20 relative overflow-hidden group/dilemma">
                  <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 space-y-2">
                      <h4 className="text-xs font-black text-fuchsia-400 uppercase tracking-[0.3em]">
                        The Moral Dilemma
                      </h4>
                      <p className="text-sm font-medium text-white leading-relaxed italic">
                        "
                        {toText(
                          char.narrative?.arcRoadmap?.moralDilemma ||
