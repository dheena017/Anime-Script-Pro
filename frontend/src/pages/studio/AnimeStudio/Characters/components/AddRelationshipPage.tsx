...
export default function AddRelationshipPage() {
  ...
  const handleRegister = () => {
    ...
    showNotification(
      `Emotional connection (${formData.source} ↔ ${formData.target}) established successfully!`,
      "success",
    );
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <Card className="p-8 bg-fuchsia-500/5 border-fuchsia-500/10 rounded-[2.5rem] space-y-4">
              <p className="text-xs text-fuchsia-200/60 leading-relaxed font-medium">
                Establish high-tension (8-10) relationships to create critical
                narrative friction points.
              </p>
              <div className="h-[1px] bg-fuchsia-500/10" />
              <p className="text-xs text-fuchsia-200/60 leading-relaxed font-medium">
                "Love" and "Secret" threads add emotional depth and
                unpredictability to your cast synthesis.
              </p>
            </Card>
          </div>
          ...
          <div className="p-8 bg-zinc-950/80 border border-white/5 rounded-[2.5rem] space-y-4">
            ...
            <p className="text-xs font-black text-zinc-500 uppercase tracking-widest leading-relaxed">
              Establishing this connection will update the global relationship
              matrix and influence script generation.
            </p>
          </div>
        </div>
      </div>
