        ...
        <div className="space-y-2 flex-1">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <span
                className={cn(
                  "text-xs font-black uppercase tracking-[0.2em] px-3 py-1 rounded-full border shadow-sm",
                  {
              ...
              <div className="flex items-center gap-1.5 bg-black/40 px-3 py-1.5 rounded-full border border-white/5">
                ...
                {[...Array(10)].map((_, i) => (
                  <div
                    key={i}
                    className={cn(
                      "w-1.5 h-2.5 rounded-sm transition-all duration-500",
                      i < conn.tension
                        ? isHighTension
                ...
                <span className="text-xs font-black text-white ml-2 tabular-nums">
                  {conn.tension}
                </span>
              </div>
            </div>
