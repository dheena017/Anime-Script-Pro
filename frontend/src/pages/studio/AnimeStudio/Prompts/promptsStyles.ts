...
export const promptsStyles = {
  ...
  header: {
    ...
    actionButton: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-red-500/50 hover:text-red-400 font-black uppercase tracking-widest text-[9px] transition-all duration-300 shadow-lg",
    ...
    actionButtonPrimary: "relative w-full sm:w-auto h-10 px-8 rounded-full border border-white/10 bg-white text-black hover:bg-zinc-100 hover:border-red-500/50 hover:text-red-500 font-black uppercase tracking-widest text-[9px] transition-all duration-300 shadow-lg",
  },
