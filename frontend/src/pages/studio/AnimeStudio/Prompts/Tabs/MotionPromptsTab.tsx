            ...
            {motionPresets.map((preset, i) => (
              <div key={i} className="flex items-center justify-between p-6 bg-white/[0.02] border border-white/5 rounded-2xl hover:border-emerald-500/20 transition-all group">
                <div>
                  ...
                  <p className="text-xs text-zinc-600 uppercase tracking-widest mt-1">{preset.type} node</p>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-xs font-black text-emerald-500/60 uppercase tracking-widest px-3 py-1 bg-emerald-500/5 border border-emerald-500/10 rounded-full">{preset.speed}</span>
