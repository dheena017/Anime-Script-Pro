...
export const storyboardStyles = {
  ...
  header: {
    ...
    icon: "w-7 h-7 text-fuchsia-400 relative z-10 drop-shadow-[0_6px_20px_rgba(217,70,239,0.18)]",
  ...
  toolbar: {
    ...
    statusActive: "text-fuchsia-400 drop-shadow-[0_0_8px_rgba(217,70,239,0.6)]",
    statusInactive: "text-zinc-600",
    statusTitle: "text-[10px] font-black uppercase tracking-[0.2em] bg-gradient-to-r from-fuchsia-300 to-fuchsia-500 bg-clip-text text-transparent",
    ...
    primaryButton: "h-9 px-4 rounded-xl font-black uppercase tracking-widest text-[9px] text-zinc-300 border-zinc-700 hover:text-fuchsia-400 hover:border-fuchsia-500/50 hover:bg-fuchsia-500/10 transition-all duration-300 group",
    iconButton: "h-9 w-9 rounded-lg text-zinc-400 hover:text-fuchsia-400 border border-transparent hover:border-fuchsia-500/40 hover:bg-fuchsia-500/10 transition-all duration-300",
  },
  ...
  page: {
    ...
    mainCard: "bg-[#030303]/40 backdrop-blur-md overflow-hidden rounded-[3rem] relative group/card transition-all duration-700",
    mainCardFrames: "border-fuchsia-500/20 shadow-[0_0_50px_rgba(217,70,239,0.15)] hover:border-fuchsia-500/40",
  ...
  progress: {
    ...
    fill: "h-full bg-gradient-to-r from-studio via-fuchsia-500 to-studio bg-[length:200%_auto] animate-[gradient_2s_linear_infinite] transition-all duration-500",
  },
