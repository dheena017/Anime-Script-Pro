...
export const storyboardStyles = {
  ...
  header: {
    ...
    iconBox: "header-icon-box group/icon rounded-2xl p-3 !bg-gradient-to-br !from-cyan-900/10 !to-cyan-500/6 !border-cyan-500/30",
    iconGlow: "absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-transparent opacity-0 group-hover/icon:opacity-100 transition-opacity duration-500 rounded-2xl",
    icon: "w-7 h-7 text-cyan-400 relative z-10 drop-shadow-[0_6px_20px_rgba(6,182,212,0.18)]",
    title: "header-title text-white font-extrabold uppercase tracking-widest text-lg",
    subtitle: "header-subtitle text-sm text-cyan-300/60",
    actionButton: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-cyan-500/50 hover:text-cyan-400 font-black uppercase tracking-widest text-xs transition-all duration-300 group/back shadow-lg",
    ...
    actionButtonPrimary: "relative w-full sm:w-auto h-10 px-8 rounded-full border border-cyan-500/30 bg-cyan-500/5 text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-500/60 hover:text-cyan-300 font-black uppercase tracking-widest text-xs transition-all duration-300 group/btn shadow-lg",
  },
  ...
  toolbar: {
    ...
    statusTitle: "text-xs font-black uppercase tracking-[0.2em] bg-gradient-to-r from-cyan-300 to-cyan-500 bg-clip-text text-transparent",
    ...
    primaryButton: "h-9 px-4 rounded-xl font-black uppercase tracking-widest text-xs text-zinc-300 border-zinc-700 hover:text-cyan-400 hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all duration-300 group",
    iconButton: "h-9 w-9 rounded-lg text-zinc-400 hover:text-cyan-400 border border-transparent hover:border-cyan-500/40 hover:bg-cyan-500/10 transition-all duration-300",
  },
  ...
  page: {
    ...
    iconBox: "w-16 h-16 rounded-[2rem] bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center shadow-[0_0_30px_rgba(6,182,212,0.15)] overflow-hidden relative shrink-0 transition-transform duration-700 group-hover:scale-110",
    cinematicGlow: "absolute inset-0 bg-gradient-to-br from-studio/10 via-transparent to-cyan-500/10 opacity-30 pointer-events-none blur-3xl",
    ...
    mainCardFrames: "border-cyan-500/20 shadow-[0_0_50px_rgba(6,182,212,0.15)] hover:border-cyan-500/40",
  ...
  card: {
    ...
    labelBadge: "absolute top-5 left-5 bg-[#050505]/90 backdrop-blur-md border border-white/10 text-zinc-100 text-xs font-black px-4 py-2.5 rounded-2xl shadow-2xl flex items-center gap-4 uppercase tracking-widest z-20 transition-all duration-700",
  ...
  progress: {
    ...
    fill: "h-full bg-gradient-to-r from-studio via-cyan-500 to-studio bg-[length:200%_auto] animate-[gradient_2s_linear_infinite] transition-all duration-500",
    label: "text-xs font-black uppercase tracking-[0.3em] text-studio/60",
    percent: "text-xs font-black text-studio",
  },
  ...
  planning: {
    ...
    itemTitle: "flex items-center gap-4 font-black tracking-[0.4em] uppercase text-xs text-studio transition-all duration-500",
  ...
  tabs: {
    container: 'flex flex-row items-center justify-center gap-2 sm:gap-3 md:gap-4 p-1.5 sm:p-2 relative mx-auto bg-[#030712]/60 border border-white/5 rounded-full backdrop-blur-xl shadow-[0_4px_20px_rgba(0,0,0,0.4)] w-fit',
    button: 'relative flex items-center justify-center gap-2.5 px-5 py-3 sm:px-6 sm:py-3.5 rounded-full text-xs font-black uppercase tracking-[0.2em] transition-all duration-300 border border-transparent whitespace-nowrap',
    buttonActive: 'border border-cyan-500/20 bg-[#05162b]/80 shadow-[0_0_20px_rgba(6,182,212,0.15)] text-cyan-400',
    buttonInactive: 'text-zinc-500 hover:text-zinc-300 hover:bg-white/[0.01]',
    pill: 'absolute inset-0 rounded-full pointer-events-none bg-cyan-500/5',
    icon: 'w-4 h-4 transition-all duration-500',
    iconActive: 'opacity-100 scale-110 text-cyan-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.6)]',
    iconInactive: 'opacity-40',
    spinner: 'w-4 h-4 border-2 border-transparent border-t-current rounded-full animate-spin',
    ...
    btn: "px-7 py-3.5 rounded-2xl text-xs font-black uppercase tracking-widest transition-all duration-500 flex items-center gap-4 shrink-0 whitespace-nowrap",
    grid: "gap-12 pb-20",
    ...
    sectionSubtitle: "text-zinc-500 text-xs font-black uppercase tracking-[0.4em] mt-2 flex items-center gap-3",
    gridTitle: "text-xs font-black text-zinc-500 uppercase tracking-widest flex items-center gap-3 mb-8",
    tabsBar: "studio-tabs-bar sticky top-0 z-40 flex items-center justify-center p-3 md:p-4 bg-[#050505]/95 backdrop-blur-md border border-white/10 rounded-[2rem] shadow-2xl mb-8 relative group overflow-hidden w-full",
    ...
    underline: 'absolute bottom-1.5 left-6 right-6 h-[2px] bg-cyan-400 rounded-full',
  },
