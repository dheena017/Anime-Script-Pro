...
export const storyboardStyles = {
  ...
  header: {
    ...
    actionButton: "relative w-full sm:w-auto h-10 px-6 rounded-full border border-white/10 bg-white/5 text-zinc-400 hover:bg-white/10 hover:border-orange-500/50 hover:text-orange-400 font-black uppercase tracking-widest text-xs transition-all duration-300 group/back shadow-lg",
    ...
    actionButtonPrimary: "relative w-full sm:w-auto h-10 px-8 rounded-full border border-orange-500/30 bg-orange-500/5 text-orange-400 hover:bg-orange-500/10 hover:border-orange-500/60 hover:text-orange-300 font-black uppercase tracking-widest text-xs transition-all duration-300 group/btn shadow-lg",
  },
  ...
  toolbar: {
    ...
    statusTitle: "text-xs font-black uppercase tracking-[0.2em] bg-gradient-to-r from-orange-300 to-orange-500 bg-clip-text text-transparent",
    ...
    primaryButton: "h-9 px-4 rounded-xl font-black uppercase tracking-widest text-xs text-zinc-300 border-zinc-700 hover:text-orange-400 hover:border-orange-500/50 hover:bg-orange-500/10 transition-all duration-300 group",
