...
const TAB_META: Record<string, { title: string; description: string; icon: any; color: string; accentColor: string; borderColor: string; bgColor: string; shadowColor: string }> = {
  frames: { title: 'Creating Keyframes', description: 'Generating cinematic keyframes and visual compositions', icon: Palette, color: 'text-fuchsia-400', accentColor: 'text-fuchsia-400', borderColor: 'border-fuchsia-500/20', bgColor: 'bg-fuchsia-500/5', shadowColor: 'rgba(217, 70, 239, 0.1)' },
