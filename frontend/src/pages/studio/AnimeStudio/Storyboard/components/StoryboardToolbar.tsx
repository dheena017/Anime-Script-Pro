              ...
              <div className="flex flex-col gap-1">
                <span
                  className={cn(
                    ...
                    isGlobalEnhancing
                      ? "from-orange-400 to-studio animate-pulse"
              ...
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-black/60 border border-white/5 rounded-2xl backdrop-blur-md shadow-inner">
                <Tooltip>
                  <TooltipTrigger>
                    ...
                    >
                      <Edit3
                        className={cn("w-4 h-4", isEditing && "animate-pulse")}
                      />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent side="top">
                  ...
                  <TooltipTrigger>
                    ...
                    >
                      <Zap
                        className={cn(
                          "w-4 h-4",
                          isGlobalEnhancing && "animate-pulse text-orange-400",
                        )}
                      />
                    </Button>
                  </TooltipTrigger>
