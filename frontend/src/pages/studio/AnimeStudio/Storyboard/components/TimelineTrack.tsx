        ...
        scenes.map((scene, idx) => (
          ...
          >
            ...
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-black text-studio uppercase tracking-tighter">
                BEAT {idx + 1}
              </span>
            ...
            <p className="text-xs font-bold text-zinc-300 uppercase tracking-tight line-clamp-1">
              {scene.section}
            </p>
