...
interface ComicStudioTopBarProps {
  onToggleEngine: () => void;
...
export function ComicStudioTopBar({ 
  onToggleEngine, 
  isEngineOpen,
  onToggleSidebar,
  isSidebarCollapsed,
  ...
  return (
    <header className={cn(
      ...
      isEngineOpen ? "backdrop-blur-2xl border-amber-500/20" : "backdrop-blur-md"
    )}>
        ...
        <button
          ...
          className={cn(
            ...
            !isGlobalSidebarOpen 
              ...
              : "text-amber-500 bg-amber-500/10 border border-amber-500/20 shadow-[0_0_15px_rgba(245,158,11,0.2)]"
          )}
          title="Global Hub"
        >
