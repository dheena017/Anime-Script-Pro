    ...
    >
      <div className="absolute top-0 right-0 p-8 flex flex-col items-end gap-1">
         <div className="flex items-center gap-1.5 px-3 py-1 bg-studio/10 rounded-full border border-studio/20">
            ...
            <span className="text-xs font-black text-studio uppercase tracking-widest">{efficiency} SYNC</span>
         </div>
      </div>
      ...
      <div className="space-y-8">
        <div className="space-y-2">
           <div className="flex items-center gap-3">
              <span className="text-xs font-black text-studio/50 uppercase tracking-widest">{id}</span>
              <div className="h-[1px] w-8 bg-studio/20" />
              <span className="text-xs font-black text-zinc-500 uppercase tracking-[0.2em]">{type}</span>
           </div>
        ...
        <div className="flex items-end justify-between pt-4">
           <div className="space-y-1">
              <span className="text-xs font-black text-zinc-600 uppercase tracking-widest block">Total Artifacts</span>
           ...
           <button className="flex items-center gap-3 group/btn">
              <span className="text-xs font-black text-zinc-100 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-500 -translate-x-4 group-hover:translate-x-0">
                 Access Data
              </span>
